...
ORIG_BASE_PATH = "/content/drive/MyDrive"
ORIG_IMAGES = os.path.sep.join([ORIG_BASE_PATH, "datasets"])
ORIG_ANNOTS = os.path.sep.join([ORIG_BASE_PATH, "datasets"])
...
BASE_PATH = "/content/drive/MyDrive/producetrainingDataNew"
POSITVE_PATH = os.path.sep.join([BASE_PATH, "new_boat"])
...
MODEL_PATH = "/content/drive/MyDrive/modelh5/boat_detector.h5"
ENCODER_PATH = "/content/drive/MyDrive/modelh5/label_encoder.pickle"
